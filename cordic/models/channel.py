...
import attr
import cordic
from cordic.models.message import Message
from cordic.models.embed import Embed
from cordic.models.file import File
from cordic.utils import simplify_attrs_from_dict, make_optional
...
class Channel:
    def __init__(self, data: Dict[str, Any]):
        ...
        self.recipients: List[cordic.User] = list(map(cordic.User, data.get("recipients", [])))
    ...
    async def send(
        ...
        return await cordic.create_message(
            channel_id=self.id,
            content=content,
            tts=tts,
            embeds=embeds,
    ...
    async def from_id(channel_id: Union[int, str]) -> Channel:
        ...
        return await cordic.fetch_channel_base(channel_id=channel_id)
