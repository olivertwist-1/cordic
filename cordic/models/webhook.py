...
from cordic.models.user import User
from cordic.models.embed import Embed
from cordic.models.file import File

from cordic.APIBase.webhook_base import async_send
...
class Webhook(BaseWebhook):
    ...
    async def delete_message(
            *,
            ...
            message: Optional[cordic.Message] = None,
        ...
        endpoint = cordic.api_url + "/webhooks/{}/{}/messages/{}{}"
    ...
    @staticmethod
    async def edit_message() -> cordic.Message:
        """Edits a message"""
