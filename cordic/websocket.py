...
class DiscordWebSocket:
    ...
    def __init__(self, client: cordic.Client, intents: int):

        self.client = client
        self.intents = intents

        self.gateaway_url = f"{cordic.gateaway_url}/?v=9&encoding=json&compress=zlib-stream"

        self.heartbeat_interval: Optional[int] = None
        self.sock: Optional[ClientWebSocketResponse] = None
        self.sequence: Optional[int] = None
        self.last_heartbeat: Optional[int, datetime.datetime] = None
