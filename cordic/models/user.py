...
class User:
    ...
    def __init__(self, data: Dict[str, Any], member_data: Optional[Dict[str, Any]] = None):
        ...
        self.premium_type: Optional[PremiumTypes] = cordic.utils.make_optional(PremiumTypes, data.get("premium_type"))
    ...
    def created_on(self) -> datetime.datetime:
        ...
        return cordic.utils.snowflake_to_date(self.id)

    @classmethod
    async def from_id(cls, user_id: int) -> User:
        """Fetches the user by the id"""
        return await cordic.fetch_user_base(user_id=user_id)
...
class Connection:
    ...
    def __init__(self, data: Dict[str, Any]):
        ...
        self.visibility: Optional[ConnectionVisibility] = cordic.utils.make_optional(
