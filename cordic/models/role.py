...
import cordic
from cordic.utils import simplify_attrs_from_dict, DataType, make_optional
from cordic.APIBase.image_base import make_role_icon
...
class Role:
    ...
    async def from_guild_id(id_: int) -> List[Role]:
        ...
        return await cordic.fetch_roles_from_guild_base(id_)